          ...
          <Column className="items-start justify-start lg:mb-[328px] xl:mb-[375px] 2xl:mb-[422px] 3xl:mb-[506px] mb-[563px] w-[15%]">
            <Column className="items-center w-[100%]">
              <Column className="items-start justify-start w-[100%]">
                <Input
                  className="bg-transparent border-0 border-b-[1px] border-bluegray_100 border-solid font-medium lg:pb-[20px] xl:pb-[23px] 2xl:pb-[25px] 3xl:pb-[31px] pb-[34.55px] pl-[0] pt-[1px] lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] placeholder:text-gray_800 text-gray_800 w-[100%]"
                  WrapClassName="w-[100%]"
                  name="Group49"
                ...
                <Column className="items-start justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[18px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] w-[60%]">
                  <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] w-[74%]">
                    <Image
                      ...
                      alt="Sweater"
                    />
                    <Text className="font-normal xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] 2xl:my-[1px] xl:my-[1px] lg:my-[1px] my-[2.5px] 3xl:my-[2px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                      Jacket
                    </Text>
                  </Row>
                  <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[60%]">
                    <Image
                      ...
                      alt="Tshirt"
                    />
                    <Text className="font-normal xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] 2xl:my-[1px] xl:my-[1px] lg:my-[1px] my-[2.5px] 3xl:my-[2px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_800 w-[auto]">
                      Shirt
                    </Text>
                  </Row>
            ...
            <Row className="lg:gap-[519px] xl:gap-[594px] 2xl:gap-[668px] 3xl:gap-[802px] gap-[891px] grid grid-cols-2 items-center justify-between px-[0] w-[100%]">
              ...
              <Row className="items-center justify-between w-[100%]">
                <Text className="font-normal not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[13px] 3xl:text-[16px] text-[18px] text-gray_500 w-[auto]">
                  <span className="text-gray_500 font-poppins">Sort by: </span>
